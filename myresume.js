...
var football;
var text;
var twitter_url="https://twitter.com/home";
var hackerearth_url="https://www.hackerearth.com/";
var codechef_url="https://www.codechef.com";
var github_url="https://github.com/Rohitjangid2704";
var facebook_url="https://www.facebook.com";
var linkedin_url="https://www.linkedin.com/in/rohit-jangid-04b95822a/";
var resume_url="https://gyu6f2e2k9n1tidkyjykkw.on.drv.tw/www.Rohit's-portfolio.com/myresume.html";
var website_url="https://gyu6f2e2k9n1tidkyjykkw.on.drv.tw/www.Rohit's-portfolio.com/myresume.html";
var gmail_url="mailto:rohitjangid2704@gmail.com";
var inst_text;
var bug;
var bug_tween;
...
function preload(){
	...
	game.load.image('MPSschool','assets/MPSschool.png');
	...
	game.load.atlasJSONHash('Rohit','assets/hero_running.png','assets/hero_running.json');
	...
	game.load.image('Rtu','assets/Rtu.png');
...
//	game.load.onLoadStart.add(loadStart, this);
  ...
  //  game.stage.scale.startFullScreen();
   ...
   //game.canvas.addEventListener('touchenter', function(){ console.log("You touched here!!");}, false);
	...
	ctext = game.add.text(5660,h-460-50,'HTML/CSS \n 98.42%',style_white2);
   ...
   //Add Explosion object pool
	...
	game.add.sprite(10620,h-235,'hackerearthLogo').scale.setTo(0.80,0.80);
	...
	game.add.text(10080,h-210,"Working on Android \n Studio \n Mini projects ",style_exS);
	game.add.text(10390,h-220,"Figma, designed website\n interface \n Website interface designing",style_exS);
	game.add.text(10680,h-230,"TheWorthyPanda\n August 2021 \n Produt Photography",style_ex); 
	game.add.text(10930,h-250,"Realme \n June-August 2021 Offical member\n Realme community",style_ex);
	game.add.text(11420,h-290,"OnePlus \n Part of OnePlus \nStudent Ambassador \nProgram 2022",style_ex);
	...
	game.add.text(12280,h-430,"Developed a eCommerce Web Application \n with frontend \n to Selling various type of courses",style_white);

	game.add.sprite(12760,h-250,'gamershq');
	game.add.text(12750,h-380,"Developed Android App \n for text extraction from images",style_white);


	game.add.sprite(13400,h-260,'harddrive').scale.setTo(0.6,0.6);
	
	game.add.text(13300,h-330,"A Small Android app for Sharing meme \n using API ",style_white);

	
	game.add.sprite(13800,h-370,'hospital');
	...
	t.start();
	game.add.text(13840,h-420,"Developed a responsive \n Iphone ",style_white);


	game.add.sprite(14750,h-500,'otherprojects');
	game.add.text(14850,h-500,"Other Projects",style_white);
	//Add Achivements Section
	game.add.tileSprite(base5+500,h-100-73*3,139*2,73*3,'brick');
	shakti = game.add.sprite(base5+1200,-500,'Sports');
	shakti.scale.setTo(0.6,0.6);
	shakti_cup = game.add.sprite(base5+500,-500,'cup');
	shakti_cup.scale.setTo(0.5,0.5);
	game.add.text(base5+505,h-300,"____ ",style_white);
	...
	game.add.text(base5+2650,h-420,".",{font:"30px Arial",fill:"#fff",align:"center"});
	
	cup4=game.add.sprite(base5+2420,-410,'cup');

	cup5=game.add.sprite(base5+3000,h-400,'cup');
	cup5=game.add.sprite(base5+3400,h-350,'building').scale.setTo(0.5,0.5);
	
	game.add.text(base5+3450,h-470,".",{font:"30px Arial",fill:"#fff",align:"center"});

	
	//Add other highlights
	game.add.sprite(base6+600,h-240,'chai');
	game.add.text(base6+680,h-330,"Chai",style_white);
	shakti2 = game.add.sprite(base6+830,-500,'Sports');
	shakti2.scale.setTo(0.75,0.75);
	game.add.text(base6+900,h-430,"Sports",style_white);
	...
	game.add.sprite(base6+1195,h-413,'yoga');
	game.add.sprite(base6+1600,h-400,'swach_bharat');
	game.add.text(base6+1240,h-500,"Holds Yoga.",style_white);
	game.add.text(base6+1590+20,h-360,"Badminton..\n Badminton\n Badminton.....",style_white);
	...
	game.add.text(base7+650,h-520+20,"tap here",{font:"20px Arial" ,fill:"#fff"});
	...
	*/
	...
	//Add hero 
	hero = game.add.sprite(100,-200,'Rohit');
...
*/
	...
	//Add MPSSchool
	var MPSschool = game.add.sprite(2200,h-220-200,'MPSschool');
	//MPSschool.scale.setTo(1.2,1.2);

	var clg = game.add.sprite(3900,h-490,'Rtu');
...
//	hero.body.gravity.y=10000;
	...
	game.add.text(w-120,100,"Download PDF",{font:"15px Roboto",fill:"#ffff"}).fixedToCamera=true;
...
function openGithub(){
 var win = window.open("https://github.com/Rohitjangid2704");
 win.focus();
}
function openCodechef(){
 var win = window.open("https://www.codechef.com");
 win.focus();
}
function openLinkedIn(){
 var win = window.open("https://www.linkedin.com/in/rohit-jangid-04b95822a/");
 win.focus();
}
...
function openHackerearth(){
 var win = window.open("https://www.hackerearth.com/");
 win.focus();
}


function openWebsite(){
 var win = window.open("https://gyu6f2e2k9n1tidkyjykkw.on.drv.tw/www.Rohit's-portfolio.com/myresume.html");
 win.focus();
}
...
function openGmail(){
 var win = window.open("mailto:rohitjangid2704@gmail.com");
 win.focus();
}

function openSpoj(){
 var win = window.open("https://twitter.com/home");
 win.focus();
}
